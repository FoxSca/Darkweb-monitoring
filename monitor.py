...
This script periodically checks a list of Onion site URLs for the presence of a specified query string.
If the query string is found on a site, it sends a notification to a Telegram chat and logs the result in a CSV file.
